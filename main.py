...
result_s_root=sqrt(item_2)
# или другой вариант
# result_s_root1= item_2**0.5
...
# или другой вариант
# result_mp_s_root1=pow(item_1, 0.5)

#  18. Вывести result_mp_s_root в консоль.
print(pow(result_mp_s_root,2))
...
resuit_m_floor=math.floor(result_division)
